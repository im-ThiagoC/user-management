...
const getStatusButtonProps = (isActive: boolean) => ({
...
const UserTableRow: React.FC<{
	...
	const { label, className } = getStatusButtonProps(user.isActive);
	...
	return (
		<TableRow key={user.id}>
			...
			<TableCell>
				<Badge variant="default">{user.profile?.name || "Unknown"}</Badge>
			</TableCell>
			<TableCell>
				<Button
					variant="outline"
